...
<div class="page-body">
    ...
    <div class="page-content">
        ...
        <form action="/admin/to_searchemployees" method="post">
            <div>
            ...
            <div class="pager-header">
                ...
                <div class="header-nav">
                    <a type="button" class="clickbutton"
                       href="/admin/to_searchemployees?status=${employee.status}&page=1">首页</a>
                    <a type="button" class="clickbutton"
                            <#if page!=1>
                                href="/admin/to_searchemployees?status=${employee.status}&page=${page-1}"
                            </#if>
                    >上页</a>
                    <a type="button" class="clickbutton"
                            <#if page!=pagenum>
                    ...
                    >下页</a>
                    <a type="button" class="clickbutton"
                       href="/admin/to_searchemployees?status=${employee.status}&page=${pagenum}">末页</a>
                    <form action="/admin/to_searchemployees"
            ...
            <#if emps??>
                <#list emps as emp>
                    <tr>
                        ...
                        <td>${emp.email}</td>
                        <td>
                            <a class="clickbutton" href="/admin/updateStatus?employeeId=${emp.employeeId}">关闭账号</a>
                        </td>
                    </tr>
                </#list>
            </#if>
